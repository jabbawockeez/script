...
select distinct concat(a.name_cache, ' [cpu]') name,
	...
	1 repeat_alert,
	null notify_default,
	'glc@kingdee.com;ziquan_liu@kingdee.com;jack_zeng@kingdee.com;rest_chen@kingdee.com;k3clouderp@163.com' notify_extra,
	'glc@kingdee.com;ziquan_liu@kingdee.com;jack_zeng@kingdee.com;rest_chen@kingdee.com;k3clouderp@163.com' notify_warning_extra,
	0 notify_warning,
	0 notify_alert,
	c.id host_id,
	3 syslog_priority,
	...
	'\N' expression,
	0 template,
	'off' template_enabled,
	0 tcheck,
	'off' exempt,
	'off' restored_alert,
	0 bl_thold_valid
from data_template_data a, graph_templates_graph b, host c, data_template_rrd d
where a.name_cache like '%CPU Utilization%CPU0%' 
and b.title_cache like '%CPU%'
and left(a.name_cache, locate(' - CPU Utilization', a.name_cache)-1) = left(b.title_cache, locate(' - ', b.title_cache)-1)
and left(a.name_cache, locate(' - CPU Utilization', a.name_cache)-1) = c.description
and d.local_data_id=a.local_data_id
and d.data_source_name='cpu'
and not exists
